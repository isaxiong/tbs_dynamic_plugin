...
class MethodChannelX5WebViewPlatform implements WebViewPlatformController {
  MethodChannelX5WebViewPlatform(
      int id, this._platformCallbacksHandler, this._javascriptChannelRegistry)
      : _channel = MethodChannel('com.xiong.tbs_dynamic/x5webview_$id') {
